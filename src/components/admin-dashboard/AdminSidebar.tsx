      ...
      <SidebarHeader>
        <div className="flex items-center gap-2 px-2 py-2">
          ...
          <div className="min-w-0 group-data-[collapsible=icon]:hidden">
            <p className="truncate font-display text-sm font-semibold leading-tight">Admin Panel</p>
            <p className="truncate text-[10px] text-muted-foreground">Audit &amp; security</p>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
